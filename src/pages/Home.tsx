    ...
    <div className="w-full">
      ...
      <section className="py-48 bg-brand-bg relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-24 items-center">
          ...
          >
            ...
            />
            <div className="absolute -bottom-10 -right-10 bg-brand-card p-10 rounded-[3rem] border border-brand-border-strong shadow-2xl hidden md:block">
          ...
          <div className="space-y-12">
             ...
             <div className="space-y-8 border-l border-brand-border-strong pl-10">
                {[
                  ...
                  <div key={i} className="space-y-2">
                     <p className="text-brand-text font-black uppercase tracking-widest text-sm">{item.title}</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Link 
                key={i} 
                to={sol.link}
                className="group p-10 bg-brand-bg rounded-[2.5rem] border border-brand-border hover:border-brand-primary/30 transition-all hover:-translate-y-2"
              >
                ...
                <h3 className="text-brand-text text-2xl font-bold mb-4">{sol.title}</h3>
      ...
      <section className="py-24 bg-brand-bg">
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-brand-card p-12 md:p-24 rounded-[4rem] text-center space-y-8 border border-brand-border relative overflow-hidden">
            <div className="absolute inset-0 bg-brand-primary/5 blur-[100px]" />
            <h2 className="text-4xl md:text-7xl font-bold text-brand-text relative z-10">Ready to Upgrade <br /><span className="italic text-brand-primary">Your Flavor Profile?</span></h2>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 relative z-10">
              <Link to="/products" className="btn-primary px-12 py-5 font-bold">Browse Catalog</Link>
              <Link to="/contact" className="px-12 py-5 rounded-2xl border border-brand-border-strong text-brand-text font-bold hover:bg-brand-fill transition-colors">Request Samples</Link>
            </div>
          </div>
        </div>
      </section>
